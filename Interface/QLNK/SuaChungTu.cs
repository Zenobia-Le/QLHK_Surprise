...
namespace QLNK
{
    public partial class SuaChungTu : MaterialForm
    {
        ...
        private readonly string[] _itemChungTu;
        private bool _flagSave;
        public SuaChungTu(string[] itemChungTu)
        {
            InitializeComponent();
            _itemChungTu = itemChungTu;
                  ...
                  ngayDk.Equals("")         || thangDk.Equals("")       || namDk.Equals("")))
            {
                    if (txtCMND.Enabled == false)
                    {
                        ...
                        if (cbDanToc.Enabled == false)
                        {
                            ...
                            _flagSave = true;
                            if (!_sourceCode.UpdateChungTu(maChungTu, tenNguoiKhai, thuongTamTru, qhVoiNguoiMat, tenNguoiMat,
                                ngaySinhNguoiMat, danToc, quocTich, cmnd, ngayQuaDoi, thoiGianQuaDoi, khuVucDangKy, ngayDangKy))
                                return;
                            Close();
        ...
        private void SuaChungTu_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            if ((maChungTu.Equals(_itemChungTu[0]) && tenNguoiKhai.Equals(_itemChungTu[1]) && thuongTamTru.Equals(_itemChungTu[2]) &&
                 qhVoiNguoiMat.Equals(_itemChungTu[3]) && tenNguoiMat.Equals(_itemChungTu[4]) && ngaySinhNguoiMat.Equals(_itemChungTu[5]) &&
                 danToc.Equals(_itemChungTu[6]) && quocTich.Equals(_itemChungTu[7]) && cmnd.Equals(_itemChungTu[8]) &&
                 ngayQuaDoi.Equals(_itemChungTu[9]) && thoiGianQuaDoi.Equals(_itemChungTu[10]) &&
                 khuVucDangKy.Equals(_itemChungTu[11]) && ngayDangKy.Equals(_itemChungTu[12])))
                return;
                ...
                case DialogResult.Yes:
                          ...
                          ngayDk.Equals("")         || thangDk.Equals("")       || namDk.Equals("")))
                    {
                        if (txtCMND.Enabled == false)
                        {
                            ...
                            {
                                danToc = "";
                                if (_sourceCode.UpdateChungTu(maChungTu, tenNguoiKhai, thuongTamTru, qhVoiNguoiMat,
        ...
        {
            var str = _itemChungTu[12].Split('/');
            label5.Visible = cbNgayDangKy.Text != str[0];
        ...
        {
            var str = _itemChungTu[12].Split('/');
            label5.Visible = cbThangDangKy.Text != str[1];
        ...
        {
            var str = _itemChungTu[12].Split('/');
            label5.Visible = cbNamDangKy.Text != str[2];
        ...
        {
            var str = _itemChungTu[5].Split('/');
            label7.Visible = cbNgaySinh.Text != str[0];
        ...
        {
            var str = _itemChungTu[5].Split('/');
            label7.Visible = cbThangSinh.Text != str[1];
        ...
        {
            var str = _itemChungTu[5].Split('/');
            label7.Visible = cbNamSinh.Text != str[2];
        ...
        {
            var str = _itemChungTu[9].Split('/');
            label11.Visible = cbNgayMat.Text != str[0];
        ...
        {
            var str = _itemChungTu[9].Split('/');
            label11.Visible = cbThangMat.Text != str[1];
        ...
        {
            var str = _itemChungTu[9].Split('/');
            label11.Visible = cbNamMat.Text != str[2];
        ...
        {
            label9.Visible = cbQuocTich.Text != _itemChungTu[7];
